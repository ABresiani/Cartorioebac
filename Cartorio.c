...
#include <string.h> //biblioteca responsoável por cuidar das strings
...
int registro() //Função responsável por cadastrar os usuários no sistema
{
	...
	file = fopen(arquivo, "a"); //Abre o arquive e o atualiza "a"
	fprintf(file,",");
	fclose(file);
...
int consulta()
{
	...
	if(file == NULL) //Função SE, == significa comparação
	{
...
int deletar()
{
	...
	remove(cpf); //Deleta o arquivo com o valor da variável
